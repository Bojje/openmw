...
namespace MWWorld
{
    ...
    void World::updateSoundListener()
    {
        ...
        if (mRendering)
        {
            ...
            const bool underwater = isUnderwater(player.getCell(), camera->getPosition());
        ...
        std::array<float, 4> emissiveColor, std::span<const std::string> additionalModels)
    {
        ...
        else if (mWorldScene)
        {
            ...
            const Render::Vec4 neutralEmissiveColor
                = { emissiveColor[0], emissiveColor[1], emissiveColor[2], emissiveColor[3] };
    ...
    {
        if (mWorldScene)
            mWorldScene->updateNeutralObjectAttachment(
                ptr, attachmentId, model, bone, visible, emissiveColor, emissiveOverride);
    }
