...
round trip and can depend on the contract without including OSG headers.
...
73 files, deleting 665 lines and adding 5,942 lines (net `+5,277`). The larger Vulkan-only
