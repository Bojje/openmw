...
86 files, deleting 845 lines and adding 6,940 lines (net `+6,095`). The larger Vulkan-only
...
explicitly during world construction; they are no longer public manager service gateways.
