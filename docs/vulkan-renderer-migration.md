...
also prewarm a bounded set of LOD-0 cell tiles, while higher LODs remain demand-driven. `WorldScene` now
...
214 code files excluding this ledger, deleting 2,490 lines and adding 19,384 lines (net `+16,894`). The larger Vulkan-only
