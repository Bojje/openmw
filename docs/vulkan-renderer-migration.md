...
This keeps the process lifecycle single-backend while the scene bridge is incomplete.
...
51 files, deleting 309 lines and adding 3,987 lines (net `+3,678`). The larger Vulkan-only
