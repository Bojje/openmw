...
- Add actors, skinning, animation, particles, weather, water, spell effects, projectiles, and post-processing.
  Active NIF particle records now convert into validated camera-facing neutral textured quads with authored static rotation; emission, aging,
