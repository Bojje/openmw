...
die-on-collision behavior; collision-spawn behavior and unsupported collider chains remain later gates.
...
214 code files excluding this ledger, deleting 2,490 lines and adding 18,363 lines (net `+15,873`). The larger Vulkan-only
...
- Add actors, skinning, animation, particles, weather, water, spell effects, projectiles, and post-processing.
  ...
  placement bounds; planar and spherical collider records now reflect neutral motion with authored bounce and
  die-on-collision behavior; collision-spawn behavior and unsupported collider chains remain to be moved out of the legacy owner.
...
full texture-layer composition remains a presentation-fidelity follow-up.
