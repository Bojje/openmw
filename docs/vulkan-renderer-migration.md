...
objects now use the same neutral position/color/radius payload, while negative and controller-driven flicker/pulse
behavior remain explicit shading gates. Enchanted neutral arrows
...
214 code files excluding this ledger, deleting 2,490 lines and adding 19,093 lines (net `+16,603`). The larger Vulkan-only
