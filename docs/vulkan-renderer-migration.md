...
187 files, deleting 2,033 lines and adding 11,522 lines (net `+9,489`). The larger Vulkan-only
...
- Port GUI, fonts, loading screens, cursor handling, and video presentation. Vulkan now has a
  deliberately small PPM screenshot path for visual checkpoints and a neutral JPEG savegame
  thumbnail path; native screenshot formats and interactive presentation remain outstanding.
