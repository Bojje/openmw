...
die-on-collision, and bounded collision-spawn snapshots; unsupported collider chains and multi-generation
spawn modifiers remain later gates.
...
214 code files excluding this ledger, deleting 2,490 lines and adding 18,387 lines (net `+15,897`). The larger Vulkan-only
...
- Add actors, skinning, animation, particles, weather, water, spell effects, projectiles, and post-processing.
  ...
  die-on-collision behavior, and bounded collision-spawn snapshots; unsupported collider chains and
  multi-generation spawn modifiers remain to be moved out of the legacy owner.
