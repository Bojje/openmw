...
die-on-collision, bounded collision-spawn snapshots, and one-step generation-spawn snapshots; unsupported
collider chains and multi-generation spawn behavior remain later gates.
...
- Add actors, skinning, animation, particles, weather, water, spell effects, projectiles, and post-processing.
  ...
  die-on-collision behavior, bounded collision-spawn snapshots, and one-step generation-spawn snapshots;
  unsupported collider chains and multi-generation spawn behavior remain to be moved out of the legacy owner.
