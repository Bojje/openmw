...
placement bounds; geometry emitters and collision modifiers remain later gates.
...
214 code files excluding this ledger, deleting 2,490 lines and adding 18,102 lines (net `+15,612`). The larger Vulkan-only
...
- Add actors, skinning, animation, particles, weather, water, spell effects, projectiles, and post-processing.
  ...
  placement bounds; geometry-emitter and collision-modifier parity remain to be moved out of the legacy owner.
